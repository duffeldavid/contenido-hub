...
## Contenido Lab (privado: solo David)

Tu laboratorio de contenido propio vive aparte, en la carpeta [`lab/`](lab/README.md): piezas con hook y guion, estadísticas de lo publicado, inspiración (reels virales desmontados) y fórmulas de hook. Se usa desde el artifact privado de claude.ai (Mac e iPhone sincronizados por la base de datos del artifact) o abriendo `lab/index.html` en local. Detalles en `lab/README.md`.
